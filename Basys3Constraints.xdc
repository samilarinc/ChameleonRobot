...
#set_property PACKAGE_PIN V3 [get_ports {Forward}]					
...
##Pmod Header JB
#Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports {Rst_n}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Rst_n}]
##Sch name = JB2
...
#	set_property IOSTANDARD LVCMOS33 [get_ports {Tx}]
##Sch name = JB4
#set_property PACKAGE_PIN B16 [get_ports {in2}]					
...
##Sch name = XA4_P
#set_property PACKAGE_PIN N2 [get_ports {in1}]				
